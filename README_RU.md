...
Вставьте (замените пример `192.0.2.10` на IP вашего MikroTik):
...
Выполните в терминале MikroTik (замените пример `192.0.2.20` на IP вашего LXC):
...
* **Rsyslog** позволил нам отфильтровать трафик: *"Если данные пришли с IP 192.0.2.10 (MikroTik), положи их в отдельный файл `mikrotik.log`"*. Это физически разделило потоки данных.
